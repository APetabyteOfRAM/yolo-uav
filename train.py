...
def _main():
    annotation_path = 'vals.txt'
    log_dir = 'logs/000/'
    classes_path = './vedai_classes.txt'
    anchors_path = './vedai_anchors.txt'
    ...
    if True:
        ...
        model.fit_generator(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
            ...
            validation_data=data_generator_wrapper(lines[num_train:], batch_size, input_shape, anchors, num_classes),
            validation_steps=max(1, num_val//batch_size),
            epochs=25,#normally 100
            initial_epoch=10,#normally 50
...
def create_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    y_true = [Input(shape=(h//{0:8, 1:4, 2:2}[l], w//{0:8, 1:4, 2:2}[l], \
    ...
    if load_pretrained:
        ...
        if freeze_body in [1, 2]:
            ...
            num = (93, len(model_body.layers)-3)[freeze_body-1]#normally 185
